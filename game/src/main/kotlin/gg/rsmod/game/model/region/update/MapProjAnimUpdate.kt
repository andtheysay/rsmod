...
class MapProjAnimUpdate(override val type: EntityUpdateType,
    ...
    override fun toMessage(): Message = if (entity.targetPawn != null) {
        ...
        MapProjAnimMessage(
                start = ((entity.tile.x and 0x7) shl 4) or (entity.tile.y and 0x7),
                pawnTargetIndex = targetIndex, offsetX = entity.targetTile.x - entity.tile.x, offsetZ = entity.targetTile.y - entity.tile.y,
        ...
        MapProjAnimMessage(
                start = ((entity.tile.x and 0x7) shl 4) or (entity.tile.y and 0x7),
                pawnTargetIndex = 0, offsetX = entity.targetTile.x - entity.tile.x, offsetZ = entity.targetTile.y - entity.tile.y,
